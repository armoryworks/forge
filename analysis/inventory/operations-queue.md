...
| Q-MR-04 | mrp | `/mrp/runs` + ExecuteMrpRunDialog (M-08) | **Trigger confirmed**: `executeRun()` / `executeRun(true)` — "Run MRP" button on runs tab; dialog at `execute-mrp-run-dialog.component.ts:30` | needs-live |
...
_Updated: 2026-05-22 · source-cataloger dequeue pass: 17 main-table rows updated to DONE; 9 QL partial remain needs-live; 30 items still open; stale :1 ref in Q-MR-04 corrected to :30_
